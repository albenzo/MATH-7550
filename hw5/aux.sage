...
theta,z= var('theta,z')
N1 = plot3d(2,(theta,0,2*pi),(z,-3,3),frame=True,transformation=S,color='purple',opacity=.8)

show(N1+M)

N2 = plot3d(1,(theta,0,2*pi),(z,-3,3),frame=True,transformation=S,color='purple',opacity=.8)
